...
@Component({
  selector: 'app-weight-attribute-tab',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './weight-attribute-tab.html',
  styleUrl: './weight-attribute-tab.scss',
})
export class WeightAttributeTabComponent {
  private readonly slugKind = 'weight' as const;
