...
import { ConfigActions } from '@app/features/config/store/config.actions';
import {
  selectColors,
  selectSimpleAttributes,
} from '@app/features/config/store/config.selectors';
import {
  ATTRIBUTE_CONFIGS,
  AttributeConfig,
} from '@app/features/config/models/config.models';
